...
export default function Seat({ seatNumber, isBooked, handleClick , isMonitor}) {
    return (
        ...
        <Button color={"gray.700"} h="fit-content" w="50px" display={"flex"} justifyContent={"center"} p="1" bg={isBooked ? "#FFC107" : "#6CAC48"} rounded={"lg"} onClick={isBooked ? null : () => { handleClick(seatNumber) }} >
            {/* seat number */}
